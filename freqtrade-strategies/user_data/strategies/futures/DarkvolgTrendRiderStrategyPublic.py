...
#
# Original repository: https://github.com/darkvolg/Trading
# Original commit: 2fa99d16870eb1bca7fea039a403616237672aa8
# Original files: FreqtradeBot/user_data/strategies/TrendRiderStrategy_public.py
# Original market: FUTURES
#
# Migration target: Freqtrade Strategy Interface V3
#
# IMPORTANT:
# No strategy optimization is allowed in this port.
# Parameters and trading logic must remain identical to source.
# ============================================================
...
class DarkvolgTrendRiderStrategyPublic(IStrategy):
    INTERFACE_VERSION = 3
